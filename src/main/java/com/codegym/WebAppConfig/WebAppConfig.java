...
public class WebAppConfig extends WebMvcConfigurerAdapter implements ApplicationContextAware {
    ...
    @Bean
    public ICityService getCityService(){return new CityService(); }
    @Bean
    public INationService getNationService(){return new NationService();}
